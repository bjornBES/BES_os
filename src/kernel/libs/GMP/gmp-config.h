...
#define GMP_LT_OBJDIR ".libs/"

/* Define to 1 to disable the use of inline assembly */
/* #undef NO_ASM */

/* Name of package */
#define GMP_PACKAGE "gmp"

/* Define to the address where bug reports for this package should be sent. */
#define GMP_PACKAGE_BUGREPORT "gmp-bugs@gmplib.org, see https://gmplib.org/manual/Reporting-Bugs.html"

/* Define to the full name of this package. */
#define GMP_PACKAGE_NAME "GNU MP"

/* Define to the full name and version of this package. */
#define GMP_PACKAGE_STRING "GNU MP 6.2.1"

/* Define to the one symbol short name of this package. */
#define GMP_PACKAGE_TARNAME "gmp"

/* Define to the home page for this package. */
#define GMP_PACKAGE_URL "http://www.gnu.org/software/gmp/"

/* Define to the version of this package. */
#define GMP_PACKAGE_VERSION "6.2.1"
