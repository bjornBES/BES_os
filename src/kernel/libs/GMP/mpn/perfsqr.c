...
mp_limb_t PERFSQR_MOD_IDX(mp_limb_t r, mp_limb_t d, mp_limb_t inv)
{
  mp_limb_t q;
  ...
  return (q * ((mp_limb_t)d)) >> PERFSQR_MOD_BITS;
}
...
int mpn_perfect_square_p(mp_srcptr up, mp_size_t usize)
{
  ASSERT(usize >= 1);
