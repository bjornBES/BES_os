...
/* Only define cob_decimal if we have the necessary mpz_struct* from gmp.h/mpir.h
...
#define COB_BSWAP_16_CONSTANT(val) ((cob_u16_t)((((cob_u16_t)(val) & (cob_u16_t)0x00FFU) << 8) | \
												(((cob_u16_t)(val) & (cob_u16_t)0xFF00U) >> 8)))

#define COB_BSWAP_32_CONSTANT(val) ((cob_u32_t)((((cob_u32_t)(val) & (cob_u32_t)0x000000FFU) << 24) | \
												(((cob_u32_t)(val) & (cob_u32_t)0x0000FF00U) << 8) |  \
												(((cob_u32_t)(val) & (cob_u32_t)0x00FF0000U) >> 8) |  \
												(((cob_u32_t)(val) & (cob_u32_t)0xFF000000U) >> 24)))

#define COB_BSWAP_64_CONSTANT(val) ((cob_u64_t)((((cob_u64_t)(val) &                           \
												  (cob_u64_t)COB_U64_C(0x00000000000000FF))    \
												 << 56) |                                      \
												(((cob_u64_t)(val) &                           \
												  (cob_u64_t)COB_U64_C(0x000000000000FF00))    \
												 << 40) |                                      \
												(((cob_u64_t)(val) &                           \
												  (cob_u64_t)COB_U64_C(0x0000000000FF0000))    \
												 << 24) |                                      \
												(((cob_u64_t)(val) &                           \
												  (cob_u64_t)COB_U64_C(0x00000000FF000000))    \
												 << 8) |                                       \
												(((cob_u64_t)(val) &                           \
												  (cob_u64_t)COB_U64_C(0x000000FF00000000)) >> \
												 8) |                                          \
												(((cob_u64_t)(val) &                           \
												  (cob_u64_t)COB_U64_C(0x0000FF0000000000)) >> \
												 24) |                                         \
												(((cob_u64_t)(val) &                           \
												  (cob_u64_t)COB_U64_C(0x00FF000000000000)) >> \
												 40) |                                         \
												(((cob_u64_t)(val) &                           \
												  (cob_u64_t)COB_U64_C(0xFF00000000000000)) >> \
												 56)))
...
#define COB_BSWAP_32(val) \
	(__extension__({ register cob_u32_t __v,				\
	     __x = ((cob_u32_t) (val));				\
...
#define COB_BSWAP_64(val) \
	(__extension__({ union { cob_u64_t __ll;				\
...
#define COB_BSWAP_32(val) \
	(__extension__({ register cob_u32_t __v,				\
	    ...
	    __v; }))
#define COB_BSWAP_64(val) \
	(__extension__({ register cob_u64_t __v,				\
	     __x = ((cob_u64_t) (val));				\
	   if (__builtin_constant_p (__x))			\
...
DECLNORET COB_EXPIMP void cob_stop_error(void);
DECLNORET COB_EXPIMP void cob_fatal_error(const enum cob_fatal_error);
DECLNORET COB_EXPIMP void cob_hard_failure_internal(const char *);
...
{
	COB_SET_RUNTIME_TRACE_FILE = 0,			  /* 'p' is  fd_t   */
	COB_SET_RUNTIME_DISPLAY_PRINTER_FILE = 1, /* 'p' is  fd_t   */
	COB_SET_RUNTIME_RESCAN_ENV = 2,			  /* rescan environment variables */
	COB_SET_RUNTIME_DISPLAY_PUNCH_FILE = 3,	  /* 'p' is  fd_t   */
	COB_SET_RUNTIME_DUMP_FILE = 4			  /* 'p' is  fd_t   */
};
COB_EXPIMP void cob_set_runtime_option(enum cob_runtime_option_switch opt, void *p);
void *cob_get_runtime_option(enum cob_runtime_option_switch opt);

COB_EXPIMP void cob_stack_trace(void *target);			/* 'target' is fd_t   */
COB_EXPIMP void cob_backtrace(void *target, int count); /* 'target' is fd_t   */
...
void cob_decimal_clear(cob_decimal *);
void cob_decimal_set_llint(cob_decimal *, const cob_s64_t);
void cob_decimal_set_ullint(cob_decimal *, const cob_u64_t);
void cob_decimal_set_field(cob_decimal *, cob_field *);
int cob_decimal_get_field(cob_decimal *, cob_field *, const int);
void cob_decimal_set(cob_decimal *, cob_decimal *); /* to be removed in 4.x */
...
void cob_decimal_align(cob_decimal *, const int);
...
void cob_logical_left_c(cob_decimal *d0, cob_decimal *d1, int sz);
void cob_logical_right_c(cob_decimal *d0, cob_decimal *d1, int sz);
#endif
