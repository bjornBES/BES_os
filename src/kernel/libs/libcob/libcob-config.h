...
#define COB_BLD_CFLAGS "-m32 -pipe -finline-functions -fsigned-char -Wall -Wwrite-strings -Wmissing-prototypes -Wno-format-y2k"

/* informational: preparser flags during compilation */
#define COB_BLD_CPPFLAGS ""

/* informational: linker during compilation */
#define COB_BLD_LD "/usr/bin/ld -m elf_i386"

/* informational: linker flags during compilation */
#define COB_BLD_LDFLAGS "-m32 -Wl,-z,relro,-z,now,-O1"

/* compiler used by cobc */
#define COB_CC "gcc"

/* compiler flags passed to compiler by cobc */
#define COB_CFLAGS "-m32 -pipe -I/opt/gnucobol-32bit/include -Wno-unused -fsigned-char -Wno-pointer-sign"

/* Compilation of computed gotos works */
#define COB_COMPUTED_GOTO 1

/* default search path for copybooks */
#define COB_CONFIG_DIR "/opt/gnucobol-32bit/share/gnucobol/config"

/* default search path for configuration files */
#define COB_COPY_DIR "/opt/gnucobol-32bit/share/gnucobol/copy"
...
#define COB_LDFLAGS "-m32"

/* default search path for extra modules */
#define COB_LIBRARY_PATH "/opt/gnucobol-32bit/lib/gnucobol"

/* libraries passed to linker by cobc */
#define COB_LIBS "-L/opt/gnucobol-32bit/lib -lcob"
