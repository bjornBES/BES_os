...
static cob_s64_t cob_binary_mget_sint64(const cob_field *const f)
{
    cob_s64_t n = 0;
...
static cob_u64_t cob_binary_mget_uint64(const cob_field *const f)
{
    cob_u64_t n = 0;
...
static void cob_binary_mset_sint64(cob_field *f, cob_s64_t n)
{
...
static void cob_binary_mset_uint64(cob_field *f, cob_u64_t n)
{
#ifndef WORDS_BIGENDIAN
    unsigned char *s;
...
void cob_move_display_to_packed(cob_field *f1, cob_field *f2)
{
    unsigned char *data1 = COB_FIELD_DATA(f1);
    ...
    {
        p++;
        i++; /* note: both p and i are about digits */
    }
...
void cob_move_packed_to_display(cob_field *f1, cob_field *f2)
{
 ...
 */
void cob_move_ibm(void *dst, void *src, const int len)
{
 ...
 * (used by INITIALIZE)
 */
void cob_init_table(void *tbl, const size_t len, const size_t occ)
{
    char *m = (char *)tbl + len;
    size_t i = len;
    size_t j = 1;
...
void cob_move(cob_field *src, cob_field *dst)
{
    ...
    {
        if (COB_FIELD_BINARY_TRUNC(dst) && !COB_FIELD_REAL_BINARY(dst))
        {
            opt = COB_STORE_TRUNC_ON_OVERFLOW;
        }
    }
    ...
    case COB_TYPE_NUMERIC_DISPLAY:
        ...
        case COB_TYPE_ALPHANUMERIC_EDITED:
            if (COB_FIELD_SCALE(src) < 0 || COB_FIELD_SCALE(src) > COB_FIELD_DIGITS(src))
            {
                /* Expand P's */
    ...
    case COB_TYPE_NUMERIC_PACKED:
        ...
        case COB_TYPE_NUMERIC_PACKED:
            ...
            if (COB_FIELD_SCALE(src) >= 0 && COB_FIELD_SCALE(dst) >= 0)
            {
...
static int cob_packed_get_int(cob_field *field)
{
    register int val;
...
static cob_s64_t display_get_long_long(cob_field *f)
{
    const short scale = COB_FIELD_SCALE(f);
    const unsigned char *data = COB_FIELD_DATA(f);
    const int sign = COB_GET_SIGN_ADJUST(f);
...
void cob_set_llint(cob_field *f, const cob_s64_t n)
{
    cob_field field;
 ...
 */
void cob_put_u64_compx(cob_u64_t val, void *mem, int len)
{
...
void cob_put_u64_comp5(cob_u64_t val, void *mem, int len)
{
    cob_u32_t uint;
    cob_u16_t ushort;
    switch (len)
...
void cob_put_s64_compx(cob_s64_t val, void *mem, int len)
{
#if !defined(WORDS_BIGENDIAN)
    cob_s64_t slong;
#endif
...
void cob_put_s64_comp5(cob_s64_t val, void *mem, int len)
{
    cob_s32_t sint;
    cob_s16_t sshort;
    switch (len)
...
cob_u64_t cob_get_u64_compx(void *mem, int len)
{
    cob_u64_t ulong;
    cob_u32_t uint;
    cob_u16_t ushort;
...
cob_u64_t cob_get_u64_comp5(void *mem, int len)
{
    cob_u64_t ulong;
    cob_u32_t uint;
    cob_u16_t ushort;
...
cob_s64_t cob_get_s64_comp5(void *mem, int len)
{
    cob_s64_t slong;
    int sint;
    short sshort;
    ...
    slong = 0;
#if defined(WORDS_BIGENDIAN)
    if (((cob_u8_t *)mem)[0] & 0x80)
    { /* Negative value */
        slong = -1;
    }
    memcpy(((cob_u8_t *)&slong) + (sizeof(cob_s64_t) - len), mem, len);
#else
    if (((cob_u8_t *)mem)[len - 1] & 0x80)
    { /* Negative value; 2s complement */
        slong = -1;
    }
...
cob_s64_t cob_get_s64_compx(void *mem, int len)
{
    cob_s64_t slong;
    int sint;
    short sshort;
...
void cob_put_s64_comp3(cob_s64_t val, void *mem, int len)
{
    int sign, dig1, dig2;
    cob_s64_t num;
    cob_u8_t *p = mem;
...
void cob_put_u64_comp3(cob_u64_t val, void *mem, int len)
{
    int dig1, dig2;
    cob_u64_t num = val;
    cob_u8_t *p = mem;
...
cob_s64_t cob_get_s64_comp3(void *mem, int len)
{
    int sign, j;
    cob_s64_t val = 0;
    cob_u8_t *p = mem;
...
cob_u64_t cob_get_u64_comp3(void *mem, int len)
{
    int j;
    cob_u64_t val = 0;
    cob_u8_t *p = mem;
...
void cob_put_u64_comp6(cob_u64_t val, void *mem, int len)
{
    int dig1, dig2;
    cob_u64_t num = val;
    cob_u8_t *p = mem;
...
cob_u64_t cob_get_u64_comp6(void *mem, int len)
{
    int j;
    cob_u64_t val = 0;
    cob_u8_t *p = mem;
...
void cob_put_s64_pic9(cob_s64_t val, void *mem, int len)
{
    cob_s64_t num;
    cob_u8_t *p = mem;
...
cob_s64_t cob_get_s64_pic9(void *mem, int len)
{
    cob_s64_t val = 0;
    cob_u8_t *p = mem;
    int sign = 1;
...
void cob_put_u64_pic9(cob_u64_t val, void *mem, int len)
{
    cob_u64_t num = val;
    cob_u8_t *p = mem;
...
cob_u64_t cob_get_u64_pic9(void *mem, int len)
{
    cob_u64_t val = 0;
    cob_u8_t *p = mem;
...
void cob_put_comp1(float val, void *mem)
{
    memcpy(mem, &val, sizeof(float));
}
void cob_put_comp2(double val, void *mem)
{
    memcpy(mem, &val, sizeof(double));
}
float cob_get_comp1(void *mem)
{
    float val;
    memcpy(&val, mem, sizeof(float));
    return val;
}
double cob_get_comp2(void *mem)
{
    double val;
...
void cob_put_pointer(void *val, void *mem)
{
    memcpy(mem, &val, sizeof(void *));
}

char *cob_get_picx(void *cbl_data, size_t len, void *char_field, size_t num_chars)
{
    size_t i;
    cob_u8_t *p = cbl_data;
...
void cob_put_picx(void *cbl_data, size_t len, void *string)
{
    size_t i, j;
    cob_u8_t *p = cbl_data;
